...
public class Kamikaze extends Enemigo {
	...
	protected static final URL url = (Nave.class.getClassLoader().getResource("Proyecto2/img/Enemigo/kamikaze.png"));
	protected static final URL urlUp = (Nave.class.getClassLoader().getResource("Proyecto2/img/Enemigo/kamikazeUP.png"));
